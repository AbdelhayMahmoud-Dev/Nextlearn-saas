  ...
  config: asyncHandler(async (req, res) => {
    ...
    ApiResponse.success(res, {
      ...
      branding: {
        ...
        font: wl?.font ?? tenant.branding?.font ?? 'inter',
      },
      features: {
        ...
        enableAffiliates: wl?.features?.affiliates ?? true,
        enableMarketplace: wl?.features?.marketplace ?? true,
        enableAIAssistant: wl?.features?.aiAssistant ?? true,
